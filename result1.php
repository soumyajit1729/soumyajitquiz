...
<body>
	...
	<h2 class="center">Hello <?php echo $_SESSION['username'] ?>, your result(section-1) is here : )</h2>
	...
	$q = "update sampletable set points = $result where name = '$name'";
	$query = mysqli_query($con, $q);
	echo $result;
	...
	<a href="quiz2.php" class="btn right">go to section 2</a>
</body>
</html>
